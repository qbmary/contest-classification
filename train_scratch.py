...
from models import create_scratch_model
...
def main():
    ...
    for epoch in range(config.EPOCHS):
        ...
        if val_metrics["accuracy"] > best_acc:
            ...
            save_path = config.MODELS_DIR / config.SCRATCH_MODEL_NAME
            save_checkpoint(
                save_path,
                model,
                class_names,
    ...
    history_path = config.OUTPUTS_DIR / "scratch_training_history.json"
